...
###定义开发环境的ip###
web_test_ip="112.74.118.115 "
###同步菜单选择###
PS3="请选择您要更新到的项目，1:部署代码到测试环境[测试]  2:退出 ==>"; export PS3
...
select COMPONENT in test.zhuna.cn quit
do
        case $COMPONENT in
        test.zhuna.cn)
            ...
            serverPath=/var/www/www.zhuna.cn/wwwroot_rsync/trunk/
            ###定义ssh auto key的文件###
            ID_RSA=${current_dir}'auth_key/id_rsa_test.rsa'
            ###定义ssh auto username###            
